...
// UInt : unsigned int - 음수값이 없다는 의미 0부터 시작 0, 1, 2, 3, 4 ....
//        용도 : 음수값이 없기 때문에 더 많은 수를 저장할 수 있다. (2배)
var myUInt : UInt = 10

// Float : 실수형(4바이트), Double : 실수형(8바이트)
// ex) 3.14, 2.46, 10/3 => 3.33333.....
var myFloat : Float = 3.14
var myDouble : Double = 2.45234
...
var myString : String = "나는 이진호입니다."
// 문자열 연결 연산자 + 사용가능 (왼쪽이나 오른쪽에 문자열형이 있어야 됨)
myString = myString + " 천재입니다."
